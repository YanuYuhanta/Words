...
class WordAdapter(private val letterId: String, context: Context) :
    ...
    override fun onBindViewHolder(holder: WordViewHolder, position: Int) {
        ...
        /*
        * dibawah merupakan action atau proses yang akan meneruskan sebuah definisi
        * kata yang akan diteruskan ke browser bawaan */
        holder.button.setOnClickListener {
            val queryUrl : Uri = Uri.parse("${DetailActivity.SEARCH_PREFIX}${item}")
            // pada kode program action_view merupakan kode yang akan meneruskan sebuah perintah ke laman web
